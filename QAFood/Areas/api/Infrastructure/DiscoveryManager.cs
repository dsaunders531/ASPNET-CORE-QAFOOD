...
namespace QAFood.Areas.api.Infrastructure
{
    /// <summary>
    ...
    /// </summary>
    public sealed class ApiDiscoveryManager
    {
        Assembly Assembly { get; set; }

        public ApiDiscoveryManager(Assembly assembly)
        {
        ...
        private bool FindApiMethod(MethodInfo method, out ApiMethod apiMethod, out string routeInfo)
        {
            ...
            {
                apiMethod = ApiMethod.GET;
                routeInfo = this.GetDefaultCustomAttributeValue(method.CustomAttributes, typeof(HttpGetAttribute));
                result = true;
            }
            else
            {
                ...
                if (methodAttr != null)
                {
                    ...
                    routeInfo = this.GetDefaultCustomAttributeValue(method.CustomAttributes, typeof(HttpPostAttribute));
                    result = true;
                }
                else
                {
                    ...
                    if (methodAttr != null)
                    {
                        ...
                        routeInfo = this.GetDefaultCustomAttributeValue(method.CustomAttributes, typeof(HttpPutAttribute));
                        result = true;
                    }
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (methodAttr != null)
                            {
                                ...
                                routeInfo = this.GetDefaultCustomAttributeValue(method.CustomAttributes, typeof(HttpDeleteAttribute));
                                result = true;
                            }
                        }
                    }
        ...
        /// <returns></returns>
        private string GetDefaultCustomAttributeValue(IEnumerable<CustomAttributeData> attributeDatas, Type targetType)
        {
